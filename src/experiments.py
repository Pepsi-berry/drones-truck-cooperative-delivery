...
class upper_solver():
    ...
    def solve_CTDRSP(self, num_uav_0, num_uav_1, uav_velocity, uav_range, truck_velocity):
        ...
        assign_best_dict = { (uav, start): (cust - self.num_truck_customer - 1, route_edge_dict[start]) for start, cust, uav in uav_assignments_best }
...
def run_JOCR_exp(env, seed, max_iter=4_000, render=None, video_record=False):
    ...
    num_customer_both = env.num_customer_both
    num_parcels_truck = env.num_parcels_truck
    num_parcels_uav = env.num_parcels_uav
    num_parcels = env.num_parcels
...
def run_MFSTSP_exp(env, seed, max_iter=3_000, render=None, video_record=False):
    ...
    num_parcels = env.num_parcels
    num_uavs = env.num_uavs
    num_uavs_0 = env.num_uavs_0
    num_uavs_1 = env.num_uavs_1
...
if __name__ == "__main__":    
        ...
        for num_uavs_0, num_uavs_1 in uav_params_set:
            ...
            for num_uav_obstacle, num_no_fly_zone in obstacle_params_set:
                ...
                for exp_no in range(num_experiments):
                    ...
                    # **CTDRSP**
                    # po.apply_async(run_CTDRSP_exp, args=(env, seed, 4_000, False, video_record, ))
                    ...
                    # **MFSTSP**
                    po.apply_async(run_MFSTSP_exp, args=(env, seed, 3_000, False, video_record, ))
                    ...
                    # **JOCR**
                    # po.apply_async(run_JOCR_exp, args=(env, seed, 4_000, False, video_record, ))
    ...
    #                 po.apply_async(run_hierarchical_exp, args=(env, masac_agent, seed, 3_000, True, False, video_record, ))
