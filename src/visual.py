...
sns.lineplot(x='customer_params', y='time_len_mean', hue='Solution', data=data, errorbar=None)
plt.xlabel('UAV num')
plt.ylabel('Time cost')
plt.title('Comparison of Time_Len Across Different Scenarios')
plt.legend(title='Solution')
# plt.show()
plt.savefig('Comparison of Time_Len Across Different Customer Numbers')
plt.close()
