...
def ParseParams():
    ...
    parser.add_argument('--test_interval', default=100,type=int, help='test every test_interval steps')
    parser.add_argument('--save_interval', default=1_000,type=int, help='save every save_interval steps')
