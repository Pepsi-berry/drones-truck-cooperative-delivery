...
class UAVEvalEnvironmentWithObstacle(Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        offset = np.array([-1 * generative_range, generative_range], dtype=np.int32)
        ...
        self.no_fly_zones = []
        self.uav_obstacles = [np.array([(self.uav_position + self.uav_target_position) / 2 - 50, [125, 125]])]
    ...
    def step(self, action):
        ...
        if True or dist_before > self.uav_velocity * self.step_len:
